...
function EditAreaLoader(){
	...
	for(var i=0; i<t.scripts_to_load.length; i++){
		steal(this.scripts_to_load[i]);	// let the time to Object editAreaLoader to be created before loading additionnal scripts
...
EditAreaLoader.prototype ={
	...
	*/	
	...
	set_base_url : function(){
		...
		this.baseURL = steal.getAbsolutePath()+'/';
	...
	getRenameFile : function(id, file_id, new_id, new_title){
