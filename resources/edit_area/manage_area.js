	...
	EditArea.prototype.check_line_selection= function(timer_checkup, onBlur){
		...
		else if( editAreas[this.id]["displayed"]==true && this.isResizing==false)
		{
	...
	EditArea.prototype.fixLinesHeight= function( textValue, lineStart,lineEnd ){
		var aText = textValue.replace(/&/g,"&amp;").replace(/</g,"&lt;").split("\n");
		if( lineEnd == -1 )
